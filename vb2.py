...
owner.login(token="Etvg8nHiTJxI09l0Crda.NIUXBR7Mi450qqY+cR9uUG.3gs8Kh5GcXOa/E4v9pSDEShUHPIWppVgdxBrtxedFm0=")
owner.loginResult()
    
vipro = VIPRO.LINE()
vipro.login(token="EtjLH6gbx8OfYNjCcij7.LPhLhWCWjB82FDhA9VEkrW.iOg1B2iehvFI9CtAuN1Q/fBShUp6+TkrNSqsl6SpgOY=")
vipro.loginResult()

ki = VIPRO.LINE()
ki.login(token="Etex4AOBf47IKA1ZMGxd.WRKA6hJVwWonsTi5d7Cthq.i+EsqeRko8d8CFJPWbRex7oIoVECU+E1Vzk++DIn5qQ=")
ki.loginResult()

ki2= VIPRO.LINE()
ki2.login(token="Et64EgFlZqTNdGnXbxl8.wr8BlaLbVZyi4hTE6KzMoa.EinC22JunMW9tIjyykmjZE4VnaQO5HG0V4AINFCIx6w=")
ki2.loginResult()

ki3 = VIPRO.LINE()
ki3.login(token="EtWNsHX8CAadVZ9x6yDd.VIdRzzroxlKksQTlhQGB3q.T7JUjl18R/ol5InwGcv7YolRiV6hfUcw12ajQHUA1i0=")
ki3.loginResult()

ki4 = VIPRO.LINE()
ki4.login(token="EsdloMMkN2sMhM4OwQI2.jz1Qiyo8fTteVc8omq81SG.863EsO/fp2QADoXUxG0HNV77BSwP/BvHtDI8sbNPEcg=")
ki4.loginResult()

ki5 = VIPRO.LINE()
ki5.login(token="Esv519rqjzF9B2jajXr5.kRgr2Y0M0rdq9ngk9YRb5q.2lrAxNEk0+ByvutG+iveYtfaEf/xt/RSWy5nJlENYqQ=")
ki5.loginResult()

ki6 = VIPRO.LINE()
ki6.login(token="EsSSelhqYDBmdlZbszQb.tNj7Qu/sBOfhwa0u/ylQIW.soTsUhvKiE6sBZ91D7Zz6jJp+aT3pSGUaX1MRgZJXBg=")
ki6.loginResult()

ki7 = VIPRO.LINE()
ki7.login(token="EskNbeE2M6MImCOCM419.sd2Uxdst7v8eavy/VvWjAq.sHIv25yE9mDsoCzHHS1KxiL7Uom/Hp7X8Zz2gsYNzJg=")
ki7.loginResult()

ki8 = VIPRO.LINE()
ki8.login(token="Es0vyiWJOknczq3apnp0.0kH/X36OYlrgRuCnPqg0ia.D1dY4+vl6XEOkcMvY9HJkPg5cpjvHGWLy8PqUX3j3uk=")
ki8.loginResult()

ki9 = VIPRO.LINE()
ki9.login(token="EtqYLHaEyr1HQAFMlkcd.N2eDjXHlnww/EQrk3xzRdq.EKo3hWR0zn3M/kZjFXkGbfM15BReAb+dap3YCGNYZn4=")
ki9.loginResult()

ki10 = VIPRO.LINE() #Ghost
ki10.login(token="EsbGfo1uNPbisSaMw1s2.iRJI38embbfwc4F7IE/XSG.ekg7AhnHLXUPSISHRIT4Jdqvl8Emi94cMO9iO1ACaMM=")
ki10.loginResult()
print "═══「GsvS ʙᴏᴛ login success」═══"
reload(sys)
...
mid =["u9691e51f073025bf367dd1daf6f78a47"]
...
Smid =["u9e2bb16ebee6238e74410cbf0abf54ba"]
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki10mid,Smid,"u9e2bb16ebee6238e74410cbf0abf54ba"]
admin=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,Smid,"u9e2bb16ebee6238e74410cbf0abf54ba","u9691e51f073025bf367dd1daf6f78a47","","",""]
creator=["u9e2bb16ebee6238e74410cbf0abf54ba"]
admsa=["u9e2bb16ebee6238e74410cbf0abf54ba"]
...
wait = {
    ...
    'sider1':"Woy..!! ngopii apa ngopi ngintip ngintip bae..!!😂",
    'joingc':"WELCOME",
    'leftgc':"SLAMAT JALAN\n\nJangan lupakan kami ya kak\njngan lupa bahagia juga 😢😢😉",
    "stickerMention":False,
    'message':"THANKS FOR ADD ME",
    "lang":"JP",
    "comment":"Thanks For Add Me",
    "comment1":"ᴀᴜᴛᴏ ʟɪᴋᴇ ⓑⓨ「📛Līჯ✝Æ  ら૯ՆԲც૦੮ 📛」\n\n\nhttp://line.me/ti/p/F_dCmc8nmZ",
    "commentOn":False,
    "likeOn":{},
    "wcOn":True,
    "leftOn":True,
...
#----------------------------------------------
		    ...
		    a = msg.text.replace("Xvideos ","")
              ...
              if msg.from_ in creator + admin:
                ...
                msg.contentMetadata = {'mid': ki9mid}
                ki9.sendMessage(msg)
                ki.sendText(msg.to,"「 SΙαρ Ραπταυ βοs 」👮")
            elif "DH1" == msg.text:
              if msg.from_ in creator + admin:
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
            ...
            elif "DH mid" == msg.text:
              if msg.from_ in creator + admin:
                vipro.sendText(msg.to,mid)
            elif "DH1 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki.sendText(msg.to,kimid)
            elif "DH2 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki2.sendText(msg.to,ki2mid)
            elif "DH3 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki3.sendText(msg.to,ki3mid)
            elif "DH4 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki4.sendText(msg.to,ki4mid)
            elif "DH5 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki5.sendText(msg.to,ki5mid)
            elif "DH6 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki6.sendText(msg.to,ki6mid)
            elif "DH7 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki7.sendText(msg.to,ki7mid)
            elif "DH8 mid" == msg.text:
              if msg.from_ in creator + admin:
                ki8.sendText(msg.to,ki8mid)
            elif "DH9 mid" == msg.text:
              if msg.from_ in creator + admin:
...
#--------------------------------------------------------
                    ...
                    msg.contentType = 7
                    msg.text = "monggo moga mimpi basah kak"
                    ...
                    msg.contentType = 7
                    msg.text = "Goib ngakak"
                    vipro.sendText(msg.to, "Goib ngakak")
            ...
            elif "Siapa gatau" in msg.text.lower():
                    msg.contentType = 7
                    msg.text = "Nah kan"
                    vipro.sendText(msg.to, "Aku gk tau kak kick ajh.. Bahaya 😁")
                    ...
                    msg.contentType = 7
                    msg.text = "Yuk dugem"
                    vipro.sendText(msg.to, "Waalaikumsalam warahmatullahi wbarokatuh.🙏")
                    ...
                    msg.contentType = 7
                    msg.text = "Hadir mblo"
                    vipro.sendText(msg.to, "Bocah ngapa ya mangggil manggil mele 😒")
                    ...
                    msg.contentType = 7
                    msg.text = "Kamu peak"
                    vipro.sendText(msg.to, "Situ lebih peak")
...
#----------------------------------------------------------
	      ...
	      if msg.from_ in creator:
                if msg.toType == 2:
                    ...
                    vipro.sendText(msg.to,"Maaf group kami sita mau keluar sendiri atau aim tendang(^_^) ")
                    targets = []
                    for g in gs.members:
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        subprocess.Popen("echo '' > dataSeen/"+msg.to+".txt", shell=True, stdout=subprocess.PIPE)
                        vipro.sendText(msg.to, "☆Goib Nongol☆")  
                        vipro.sendMessage(msg)
                    else:
                        vipro.sendText(msg.to, "●Belum Ada Goib●")
                    print "Viewseen"
...
#------------------------------------------------------------
                ...
                msg.contentType = 13
                admin1 = "u9e2bb16ebee6238e74410cbf0abf54ba"
                admin2 = ""
                admin3 = ""
                admin4 = ""
                admin5 = ""
...
#-----------------------------------------------
              ...
              if msg.from_ in creator + admin:
                if msg.toType == 2:
                        G = vipro.getGroup(msg.to)
                        ginfo = vipro.getGroup(msg.to)
                        vipro.sendText(msg.to,"waitting mbah...")
...
#-----------------------------------------------
                ...
                vipro.sendMessage(msg)
            elif msg.text in ["Cuy on"]:
             if msg.from_ in admin:
                wait["Ghost"] = True
                vipro.sendText(msg.to,"Encuy Sudah Aktif Kapten")
            elif msg.text in ["Cuy off"]:
             if msg.from_ in admin:
                wait["Ghost"] = False
                vipro.sendText(msg.to,"Encuy Di Nonaktifkan")
		...
		if msg.from_ in admin:
              ...
              if msg.from_ in creator + admin:
                vipro.sendText(msg.to,"Woy ")
                ki.sendText(msg.to,"Ngopi ")
                ki2.sendText(msg.to,"Apa 􀜁􀇔􏿿")
                ki3.sendText(msg.to,"Ngopi 􀜁􀇔􏿿")
                ki4.sendText(msg.to,"Diem 􀜁􀇔􏿿")
                ki5.sendText(msg.to,"Diem ??􀇔􏿿")
                ki6.sendText(msg.to,"Baee 􀜁􀇔􏿿")
                ki7.sendText(msg.to,"Kopi nikmat?? 􀜁􀇔􏿿")
                ki8.sendText(msg.to,"Yaa 􀜁??􏿿")
                ki9.sendText(msg.to,"Kopi kapal api 􀜁􀇔􏿿!!")
...
#-----------------------------------------------        
	...
	if op.type == 11:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
            	c = Message(to=op.param1, from_=None, text=None, contentType=13)
                c.contentMetadata={'mid':'u9e2bb16ebee6238e74410cbf0abf54ba'}
                vipro.sendImageWithURL(op.param1,"http://dl.profile.line-cdn.net/0hkxIgSlqKNFd0Hhk-aKBLAEhbOjoDMCUfGnlyMFFOPjRfLnJRHSooMwEdOWMMfXIASXB5M1lOPTAM")
                if (wait["message"] in [""," ","\n",None]):
                    pass
                else:
